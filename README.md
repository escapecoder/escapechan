...
```
Примечание: PHP нужен только для следующих файлов в директории "root":

- adminer.php (менеджер баз данных)
- ndx.php (cron-скрипт для перерисовки статистики на главной странице)
- telegram_webhook.php (вебхук для Telegram-бота получения пасскодов)

Если ни одним из этих файлов пользоваться не планируется, PHP можно не устанавливать.
```
